...
/**
 * This class holds the library of movies created from the file movies.txt and
 * the searches and sorts to be preformed on them.
 * 
 * @author Satshabad
 * 
 */
public class MovieLibrary {
    ...
    /**
     * This is the number of movies current in {@link #movieList}.
     */
    ...
    MovieLibrary() {
        ...
        // 3 is the number of actors in a movie
    ...
    /**
     * This method has been replaced by linear search to add partial search
     * functionality. it used to be a beautiful binary search method
     * 
     * @param array
     * @param target
     * @return
    ...
    /**
     * This internal method takes an array of {@link StringPointerPair}s and
     * gives back an array of their corresponding {@link Movie}s
     * 
     * @pre the passed array is non null
     * @post the movies are returned in an array in the correct order
     * @param array
     *            the array of {@link StringPointerPair}s
     * @return the array of corresponding {@link Movie}s
     */
